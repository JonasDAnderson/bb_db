...
def insert_users(insert_users_list):
        c.executemany('INSERT OR IGNORE INTO users (telegram_handle, created_at) VALUES (?,?)', insert_users_list)
...
def insert_retailers(retailer_id, name, website, free_shipping_amount, created_at):
        c.execute("""INSERT OR IGNORE INTO retailers 
                ...
                VALUES(?,?,?,?)""", (name, website, free_shipping_amount, created_at))
...
# New changes
create()
insert_users_list = [('xander', 'fang')]
insert_users(insert_users_list)
